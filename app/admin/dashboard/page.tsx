            ...
            <div className="p-6 space-y-8 max-w-4xl mx-auto w-full">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 pb-10">
                    ...
                    >
                        ...
                        <div>
                            <p className="font-black text-slate-900 uppercase tracking-tight text-xs">Analytics Engine</p>
                            <p className="text-[10px] text-slate-400 font-medium mt-1">Performance & Logs Temps Réel</p>
                        </div>
                    </button>
